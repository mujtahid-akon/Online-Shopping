...
<div class="outer_div">
<h2 class="head_2">Click The Update Button to Update that Sub Category</h2>
<?php if(isset($records)): foreach ($records as $row): ?>
	<div class="delet_row">
		<div class="left_div">
			<h2><?php echo anchor("database_controller/update_sub_category/$row->SUB_CAT_ID",'Update') ; ?></h2>
		</div>
		<div class="right_div">
...
<div class="home">
 	<?php echo anchor('database_controller', 'Home');?>
</div>
