...
<div class="outer_div">
<h2 class="head_2">Click The Choose Button to Choose Orders</h2>
<?php if(isset($records)): foreach ($records as $row): ?>
	<div class="delet_row">
		<div class="left_div">
			<h2 class="reduce_padding"><?php echo anchor("needed_product_controller/choose_product/$row->PRODUCT_ID/$row->OUTLET_ID",'Choose') ; ?></h2>
		</div>
		<div class="right_div">
...
<div class="home">
 	<?php echo anchor('needed_product_controller/show_prev_order', 'Previous Orders');?>
</div>
<div class="home">
