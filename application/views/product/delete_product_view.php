...
<div class="outer_div">
<h2 class="head_2">Click The Delete Button to Delete that Product</h2>
<?php if(isset($records)): foreach ($records as $row): ?>
	<div class="delet_row">
		<div class="left_div">
			<h2><?php echo anchor("delete_database_controller/delete_product/$row->PRODUCT_ID",'Delete') ; ?></h2>
		</div>
		<div class="right_div">
