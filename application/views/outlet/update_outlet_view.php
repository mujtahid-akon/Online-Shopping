...
<div class="outer_div">
<h2 class="head_2">Click The Update Button to Update that Outlet</h2>
<?php if(isset($records)): foreach ($records as $row): ?>
	<div class="delet_row">
		<div class="left_div">
			<h2 class="reduce_padding"><?php echo anchor("update_database_controller/update_outlet/$row->OUTLET_ID",'Update') ; ?></h2>
		</div>
		<div class="right_div">
			<div class="name"><?php echo $row->OUTLET_NAME; ?></div>
